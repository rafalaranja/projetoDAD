      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="text-center">
            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="@/assets/logo.png" alt="...">
          </div>
          <p>Irure et dolore veniam mollit. Aliqua qui laboris occaecat excepteur fugiat. Ea nulla eu eu esse labore irure
            reprehenderit consequat aliqua. Laboris eiusmod minim ipsum ad do velit fugiat consequat voluptate ulla</p>
        </div>
      </div>
