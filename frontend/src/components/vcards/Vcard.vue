...
<template>
  ...
  <vcard-detail :operationType="operation" :vcard="vcard" :transactions="transactions"
    :fixedTransaction="fixedTransaction" :errors="errors" @save="save" @cancel="cancel"></vcard-detail>
</template>