  ...
  <form class="row g-3 needs-validation" novalidate @submit.prevent="save">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" :class="{ 'is-invalid': errors ? errors['name'] : false }" id="inputName"
        placeholder="Project Name" required v-model="editingProject.name">
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <select class="form-select pe-2" :class="{ 'is-invalid': errors ? errors['responsible_id'] : false }"
          id="inputResponsible" v-model="editingProject.responsible_id">
      ...
      <div class="mb-3 ms-xs-3 flex-grow-1">
        ...
        <select class="form-select" :class="{ 'is-invalid': errors ? errors['status'] : false }" id="inputProject"
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <input type="date" class="form-control" :class="{ 'is-invalid': errors ? errors['preview_start_date'] : false }"
          id="inputPreview_start_date" placeholder="Preview Start Date" v-model="editingProject.preview_start_date">
      ...
      <div class="mb-3 ms-xs-3 flex-grow-1">
        ...
        <input type="date" class="form-control" :class="{ 'is-invalid': errors ? errors['preview_end_date'] : false }"
          id="inputPreview_end_date" placeholder="Preview End Date" v-model="editingProject.preview_end_date">
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <input type="date" class="form-control" :class="{ 'is-invalid': errors ? errors['real_start_date'] : false }"
          id="inputReal_start_date" placeholder="Real Start Date" v-model="editingProject.real_start_date">
      ...
      <div class="mb-3 ms-xs-3 flex-grow-1">
        ...
        <input type="date" class="form-control" :class="{ 'is-invalid': errors ? errors['real_end_date'] : false }"
          id="inputReal_end_date" placeholder="Real End Date" v-model="editingProject.real_end_date">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" :class="{ 'is-invalid': errors ? errors['total_hours'] : false }"
        id="inputTotalHours" v-model="editingProject.total_hours">
      ...
      <div class="mb-3 checkBilled">
        <div class="form-check">
          <input class="form-check-input" :class="{ 'is-invalid': errors ? errors['billed'] : false }" type="checkbox"
            v-model="editingProject.billed" id="inputBilled">
      ...
      <div class="row mb-3 total_price" v-show="editingProject.billed">
        ...
        <div class="col-sm-9">
          <input type="number" class="form-control" :class="{ 'is-invalid': errors ? errors['total_price'] : false }"
            id="inputTotalPrice" v-model="editingProject.total_price">
